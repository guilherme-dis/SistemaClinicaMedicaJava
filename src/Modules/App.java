...
public class App {
    ...
    public static void main(String[] args) {
        ...
        date = new Date();
        pacientes.cadastrar(PacienteComPlanoDeSaude.cadastroPacienteComPlanoDeSaude("Guilherme", "70122924665", "11111", "Solteiro", "Masculino", date, date, planoDeSaude.buscar("Assim Saúde"), "", "", date));
